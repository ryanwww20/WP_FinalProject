...
export async function PUT(
  ...
  try {
    ...
    membership.location = {
      ...
      placeTypes: placeTypes && Array.isArray(placeTypes) ? placeTypes : undefined,
    ...
    const locations = membersWithLocation
      ...
      .map((member: any) => {
        ...
        return {
          ...
          placeId: member.location.placeId || undefined,
          placeTypes: member.location.placeTypes || undefined,
